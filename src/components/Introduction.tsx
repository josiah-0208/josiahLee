...
function Introduction({}: Props) {
  ...
  return (
    <>
      <div className="max-w-[768px] flex md:flex-col flex-wrap gap-[32px]">
        ...
        <div className="w-[520px] flex flex-col gap-2.5">
          <p className="whitespace-pre-wrap leading-relaxed">
            {t('text_1._1')}
            <span className="text-highlightTextColor">{t('text_1.var_1')}</span>
            {t('text_1._2')}
          </p>
          <p className="whitespace-pre-wrap leading-relaxed">{t('text_2')}</p>
          <p className="whitespace-pre-wrap leading-relaxed">
            {t('text_3._1')}
            <span className="text-highlightTextColor">{t('text_3.var_1')}</span>
            {t('text_3._2')}
          </p>
          <p className="whitespace-pre-wrap leading-relaxed">
            {t('text_4._1')}
            <span className="text-highlightTextColor">{t('text_4.var_1')}</span>
            {t('text_4._2')}
          </p>
        </div>
        {/* </div> */}
        ...
        <div className="w-[520px] flex flex-col gap-2.5">
          ...
          <p className="whitespace-pre-wrap leading-relaxed">
            {t('text_6._1')}
            <span className="text-highlightTextColor">{t('text_6.var_1')}</span>
            {t('text_6._2')}
          </p>
          <p className="whitespace-pre-wrap leading-relaxed">{t('text_7')}</p>
          <p className="whitespace-pre-wrap leading-relaxed">
            {t('text_8._1')}
            <span className="text-highlightTextColor">{t('text_8.var_1')}</span>
            {t('text_8._2')}
          </p>
        </div>
        <div className="w-[216px] h-[216px] flex flex-col justify-evenly bg-secondColor rounded-2xl border-2 border-borderColor">
