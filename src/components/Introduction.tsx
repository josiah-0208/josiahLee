...
function Introduction({}: Props) {
  ...
  return (
    <>
      <div className="w-full md:w-[768px] flex flex-col gap-[32px]">
        <div className="flex flex-col md:flex-row items-center gap-[32px]">
          ...
          <div className="w-[80%] md:w-[520px] flex flex-col gap-2.5">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-[32px]">
          <div className="w-[80%] md:w-[520px] flex flex-col gap-2.5">
            <p className="whitespace-pre-wrap leading-relaxed">
              {t('text_5._1')}
              <HoverATag
